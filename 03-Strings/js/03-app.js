...
//  Uso de template Strings  o  template literals con la actualización de JavaScript 6
console.log(`La pantalla de 40\" tiene un precio de ${precio} producto ${unica} lléveselo  ${promocion}`); //  Uso de Backtick o Acento Grave